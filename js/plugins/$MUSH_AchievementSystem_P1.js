...
MUSH_Achievements.prototype.createSceneDetails = function() {
	...
	this._snDetails = {};
		...
		//-----------------------------------------------
		this._snDetails.textPop = "Completado: ";
		...
		//-----------------------------------------------
		this._snDetails.sceneTitle = "Logros";
		...
		//   - One line Max.
		//-----------------------------------------------
		this._snDetails.sceneDescription = "¡Presiona Z para cambiar la vista de la escena!";
		...
		//-----------------------------------------------
		this._snDetails.iconNotUnlocked = 286;
		...
		//-----------------------------------------------
		this._snDetails.textCompletion = "Completado: ";
		...
		//-----------------------------------------------
		this._snDetails.textReward   = "Premio: ";
		this._snDetails.textNoReward = "Nada";
...
MUSH_Achievements.prototype.createAchievementsList = function() {
	...
	//-------------------------------------------------------------------------------
		...
		["El Reinado de la Muerte Cayo", 281, "",         "Superaste la prueba ante la muerte.",              "-1/0/0",   "2/994/1",  false, true,  true] ,
		["¿Estás seguro de lo que haces?", 283, "",         "Reclutaste a los personajes de Touhou 1 de la ruta del Makai.",              "-1/0/0",   "2/991/3",  false, true,  true] ,
		["El Reinado del Espadachín Cayo", 30, "",         "Superaste la prueba ante el infierno.",              "-1/0/0",   "2/990/1",  false, true,  true] ,
		["Buena suerte con ellos", 285, "",         "Reclutaste a los personajes de Touhou 1 de la ruta del Infierno.",              "-1/0/0",   "2/992/3",  false, true,  true] ,
		["Bueno la prueba del Yin Yang termino.", 282, "",         "Reclutaste a los personajes de Touhou 1.",              "-1/0/0",   "2/993/7",  false, true,  true] ,
		["La Reina Escarlata Cayo", 29, "",         "Superaste el incidente del cielo escarlata.",              "-1/0/0",   "2/44/1",  false, true,  true] ,
		["La Bolsa De Valores Cayo",      13, "",         "Acabaste con el trafico de cartas básico.",              "-1/0/0",    "2/42/1",  false, true,  true] ,
		//["Completista",           3, "",         "Completa todos las historias.",          "3/0/1000", "2/11/6",  false, true,  true] , 
		["Jugador Incondicional",          4, "",         "Acumula al menos 5 segundos de juego.", "2/4/1",    "3/300/0", false, false, false] , 
		["La Señora Scarlet Te Saluda Con Todos Sus Súbditos", 15, "",         "Reclutaste a los personajes de Touhou 6.",              "-1/0/0",   "2/45/9",  false, true,  true] ,
		["Descuentos Por Parte De La Diosa", 14, "",         "Reclutaste a los personajes de Touhou 18.",              "-1/0/0",   "2/47/8",  false, true,  true] ,
		["La Diosa del Marketing Ponen A Todos A Precio Justo", 319, "",         "Acabaste con el mercado negro.",              "-1/0/0",   "2/46/9",  false, true,  true] ,
		["¡Me gustan los paseos!",           5, "",         "Camina 10 pasos.",                            "3/0/1000", "4/10/0",  false, false, false] 
